...
<body>
    ...
    <div class="container">
        <img class="imagen" src="./imagenes/barril.jpg" alt="" width="150" height="150">
        <img class="imagen" src="./imagenes/Merry.webp" alt="" width="150" height="150">
        <img class="imagen" src="./imagenes/Sunny.webp" alt="" width="150" height="150">
        <?php
